      ...
      <Container>
        ...
        <div className="ms-auto d-md-none navbar-text">
          <button className="vvd small-button" onClick={handleNavigate}>
            {/* <span className="text-white border-white">Unlock Fintick</span> */}
          </button>
        </div>
        ...
        <Navbar.Collapse id="basic-navbar-nav"
          ...
          <span className="navbar-text">
            <div className="social-icon">
              <a
                href="https://www.linkedin.com/in/dhrutinandan-swain-684743231/"
                target="_blank"
                rel="noreferrer"
              >
                <img src={navIcon1} alt="" />
              </a>
              <a href="https://www.linkedin.com/in/dhrutinandan-swain-684743231/" target="_blank" rel="noreferrer">
